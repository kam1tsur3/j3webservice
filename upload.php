...
<section>
<h2>キャスト採用</h2>
MatatabiHouseでは一緒に働いてくれる猫を募集します。<br>
応募したい場合は以下のフォームから名前、猫の写真をアップロードしてください。<br>
<?php
print<<<EOF
	<form method="POST" action="./upload_result.php" enctype="multipart/form-data">
	猫名：<input required type="text" name="cat_name" pattern="^[0-9A-Za-z\u3041-\u3096\uFF10-\uFF19\u30A1-\u30F6]+$"><br>
	画像：<input type="file" name="upfile" accept="image/png, image/jpeg, image/gif" value="500000"><br>
