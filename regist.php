...
print<<<EOF
	<form method="POST" action="./regist_result.php">
	お名前:<input type="text" name="login_name" pattern="^[0-9A-Za-z\u3041-\u3096\uFF10-\uFF19\u30A1-\u30F6]+$">
	<br>
	パスワード:<input type="password" name="pwd"  pattern="^[0-9A-Za-z]+$">
	<br>
...
EOF;
		...
		print "ログイン済みです。<br>";
		print "再度新規登録する場合は一度ログアウトしてください。<br>";
	}
?>
